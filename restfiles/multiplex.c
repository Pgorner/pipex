...
/*   Updated: 2023/01/20 15:08:19 by pgorner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_vs(int argc, char *argv[], char *env[], t_s *vs)
{
	...
	vs->one = argv[2];
	vs->two = argv[3];
	vs->pone = ft_split(argv[2], ' ');
	vs->ptwo = ft_split(argv[3], ' ');
	//vs->path = ft_calloc(sizeof(char), vs->num);
...
int		main(int argc, char *argv[], char *env[])
{
	...
	check_path(&vs, vs.pone);
	check_path(&vs, vs.ptwo);
	gabel = fork();
	if (gabel < 0)
